...
import { Container, H1 ,P, PageLoader} from '../../utills/components';
import { height, width } from 'react-native-dimension';
import { RootScreenProps } from '../../Routes/types';
import { PayslipBreakDownParams, useFetchPayslipInfoProps } from './types';
import { HeaderWithBackButton } from '../../components/Headers/CustomHeader';
export default function PayslipBreakDown({route} : RootScreenProps) {
  const {payroll} = route.params as PayslipBreakDownParams || {}
    ...
    <ScreenWrapper>
      <View style={styles.container}>
        <HeaderWithBackButton 
          headerText='Payslip Breakdown'
        />
        {
          loading ? <PageLoader /> :  <ScrollView showsVerticalScrollIndicator={false}>
