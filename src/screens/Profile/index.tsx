...
export default function Profile({navigation}: RootScreenProps) {
  ...
  const {data: about, isLoading: loading} = useFetchAboutMe(
    'main',
  ...
  const {data: kinsData, isLoading: loadingKin} = useFetchKin(
    about?.id,
  ) as useFetchKinProps;

  const {data: emergData, isLoading: loadingEmergency} = useFetchEmergency(
    about?.id,
  ...
  const RenderList = ({
    ...
    if (index == selectedIndex) isExpanded = true;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <View style={CommonStyles.rowAlignItemCenter}>
            ...
            />
            <Text style={[styles.listCompTitle, CommonStyles.marginLeft_2]}>
              {item.title}
            </Text>
          </View>
          <Image
        ...
        {isExpanded && (
          <>
              ...
              <View style={CommonStyles.marginBottom_3}>
                <View
                  ...
                  <TopBottomText
                    topText={data[0]}
                    bottomText={`${
                      about && about.address && about.address.country_display
                  ...
                  <TopBottomText
                    topText={data[2]}
                    bottomText={`${
                      about && about.gender_display
                        ? Capitalize(about.gender_display)
                        : ''
                    }`}
                  />
                  <TopBottomText
                    topText={data[4]}
                    bottomText={`${
                      about && about.marital_status
                        ? Capitalize(about.marital_status)
                        : ''
                    }`}
                  />
                </View>
                <View
                  style={[
                    CommonStyles.rowJustifySpaceBtw,
                    CommonStyles.marginTop_4,
                  ]}>
                  <TopBottomText
                    topText={data[6]}
                    bottomText={`${
                      about && about.birth_date
                        ? moment(about.birth_date).format('DD MMM YYYY')
                        : ''
                    }`}
                  />
                </View>
              ...
              <View style={CommonStyles.marginBottom_3}>
                <View
                  ...
                  <TopBottomText
                    topText={data[0]}
                    bottomText={
                      about && about.hire_date
                        ? moment(about.hire_date).format('DD,MMM YYYY')
                        : ''
                    }
                  ...
                  <TopBottomText
                    topText={data[2]}
                    bottomText={
                      about && about.type_display
                        ? Capitalize(about.type_display)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                ...
                <View
                  ...
                  <TopBottomText
                    topText={data[4]}
                    bottomText={
                      about && about.job && about.job.title
                        ? Capitalize(about.job.title)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                ...
                <View
                  ...
                  <TextWithButton
                    topText={data[8]}
                    bottomText={
                      about && about.compensation && about.compensation.amount
                        ? numeral(about.compensation.amount).format('0,0.00')
                        : ''
                    }
                    onPressHandler={() =>
                      navigation.navigate('Profile', {screen: 'Compensation'})
                    }
                  />
                </View>
              </View>
              ...
              <View style={CommonStyles.marginBottom_3}>
                <View
                  ...
                  <TopBottomText
                    ...
                    bottomText={
                      kinsData?.first_name
                        ? Capitalize(kinsData.first_name)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                  <TopBottomText
                    topText={data[2]}
                    bottomText={
                      kinsData?.last_name ? Capitalize(kinsData.last_name) : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                </View>
                <View
                  ...
                  <TopBottomText
                    topText={data[4]}
                    bottomText={
                      kinsData?.relationship
                        ? Capitalize(kinsData.relationship)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                  <TopBottomText
                    topText={data[6]}
                    bottomText={
                      kinsData?.phone_number ? kinsData.phone_number : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                </View>
                <View
                  ...
                  <TopBottomText
                    topText={data[8]}
                    bottomText={kinsData?.address1 ? kinsData.address1 : ''}
                  />
                </View>
                <View
                  style={[
                  ...
                  <TopBottomText
                    topText={data[10]}
                    bottomText={kinsData?.email ? kinsData.email : ''}
                  />
                </View>
              </View>
            ) : null}
              ...
              <View style={CommonStyles.marginBottom_3}>
                <View
                  ...
                  <TopBottomText
                    topText={data[0]}
                    bottomText={
                      emergData?.first_name
                        ? Capitalize(emergData.first_name)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                  <TopBottomText
                    ...
                    bottomText={
                      emergData?.last_name
                        ? Capitalize(emergData.last_name)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                ...
                <View
                  ...
                  <TopBottomText
                    topText={data[4]}
                    bottomText={
                      emergData?.relationship
                        ? Capitalize(emergData.relationship)
                        : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                  <TopBottomText
                    topText={data[6]}
                    bottomText={
                      emergData?.phone_number ? emergData.phone_number : ''
                    }
                    containerStyle={styles.halfWidthContainer}
                  />
                </View>
                <View
                  ...
                  <TopBottomText
                    topText={data[8]}
                    bottomText={emergData?.address1 ? emergData.address1 : ''}
                  />
                </View>
                <View
                  style={[
                  ...
                  <TopBottomText
                    topText={data[10]}
                    bottomText={emergData?.email ? emergData.email : ''}
                  />
                </View>
              </View>
            ) : null}
            ...
            {item.title.includes('Bank') && (
              <View
                style={[CommonStyles.marginTop_2, CommonStyles.marginBottom_3]}>
                <TopBottomText
                  topText={data[0]}
                  bottomText={
                    about?.bank_account?.bank?.name
                      ? Capitalize(about.bank_account.bank.name)
                      : ''
                  }
                />
                <TopBottomText
            ...
            <View style={styles.mainViewContainer}>
              <View style={styles.userInfoContainer}>
                ...
                <Text numberOfLines={1} style={styles.nameText}>
                  {`${
                    about && about.first_name
                      ? Capitalize(about.first_name)
                      : ''
                  }`}{' '}
                  {`${
                ...
                <Text
                  numberOfLines={1}
                  style={[styles.designationText, CommonStyles.marginTop_05]}>
                  {`${about && about.title ? Capitalize(about.title) : ''}`}
                </Text>
                {about?.title_display && about?.level ? (
                  <View
                    style={[
                      CommonStyles.rowAlignItemCenter,
                      CommonStyles.marginTop_05,
                    ]}>
                    <Text numberOfLines={1} style={styles.designationText}>
                      {`${
                        about && about.title_display
                          ? Capitalize(about.title_display)
                          : ''
                      }`}{' '}
                      |{' '}
                    </Text>
                    <Text
                      numberOfLines={1}
                      style={[styles.designationText, {fontWeight: 'bold'}]}>
              ...
              </View>
              {
                <Container>
                  {profileData.map((item, index) => (
                    <RenderList item={item} index={index} key={index} />
                  ))}
                </Container>
              }
            </View>
