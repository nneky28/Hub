...
export default function SearchBox({ title, containerStyle, onSubmitEditing, ...inputProps }:SearchBoxProps) {
...
export const SearchBoxIOS = ({ title, containerStyle, onSubmitEditing}:SearchBoxIconRightProps) => {
    const dispatch = useDispatch();
    useEffect(() => {
        Keyboard.addListener('keyboardDidShow', () => dispatch(setBottomTabBarVisible(false)));
        Keyboard.addListener('keyboardDidHide', () => dispatch(setBottomTabBarVisible(true)))
