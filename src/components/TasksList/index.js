...
const TasksList = ({ data, whos_out, birthdays, navigate, upcoming_birthdays, anniversary, getWhosOut, fetch, tab, upcoming_anniversary }) => {
  return (
    <FlatList
      data={data}
...
const RenderItem = ({ item, whos_out, birthdays, navigate, upcoming_birthdays, upcoming_anniversary, anniversary, getWhosOut, fetching, tab }) => {
  ...
  return (
    <React.Fragment>
      ...
      <View style={styles.container}>
        ...
        {
          selected === "Job Anniversary" && upcoming_anniversary && Array.isArray(upcoming_anniversary)
            && upcoming_anniversary.length === 0 ? (
            <Container
              style={{ justifyContent: "center", alignItems: "center" }}
              marginTop={3}
            >
        ...
        {show ? (
          <>
            <FlatList
              data={selected === "Job Anniversary" && upcoming_anniversary && Array.isArray(upcoming_anniversary) ? upcoming_anniversary : selected !== "Job Anniversary" && item && item.title !== "Celebrations" && whos_out && Array.isArray(whos_out) ?
                whos_out :
