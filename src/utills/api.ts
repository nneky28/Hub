...
export const APIFunction = {
  ...
  get_personal_upcoming: async (id:any) => {
    let biz = await getStoredBusiness()
  ...
  get_personal_overdue: async (id:any) => {
    let biz = await getStoredBusiness()
